...
params <- list(
  config_yml = '/Users/csmith/git/bioinfo-fio/tme/test_data/tme.yml',
  ...
  counts_f = '/Users/csmith/git/bioinfo-fio/tme/test_data/pact_rsem_raw.exprs.gid.tsv.gz',
  metadata_f = '/Users/csmith/git/bioinfo-fio/tme/test_data/meta_pact_xena.tsv'
)
```
...
message(paste('meta_f:', params$metadata_f))
assign('meta_f', params$metadata_f)
